...
void Shader::SetUniform3f(const std::string& name, float r, float g, float b)
{
	glUniform3f(GetLocation(name), r, g, b);
}

void Shader::SetUniform1f(const std::string& name, float r)
{
	glUniform1f(GetLocation(name), r);
}
